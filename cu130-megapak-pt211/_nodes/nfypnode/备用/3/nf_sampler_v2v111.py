...
class NanFengSamplerAdvancedV2V:
    ...
    def _prepare_second_pass_input_latent(self, first_pass_output, 二采使用放大模型, 二采放大模型, 二采VAE=None, stage_label=""):
    ...
    def _run_second_pass(self, first_pass_output, guider, sampler, 添加噪波, 噪波种子, 二采使用放大模型, 二采放大模型, 二采西格玛, 二采VAE=None, 二采引导器=None, 二采采样器=None):
    ...
    def _run_single_pipeline(self, 引导器, 采样器, latent_input, 一采西格玛文本, 添加噪波, 噪波种子, 启动二采, 二采使用放大模型, 二采放大模型, 二采西格玛, 西格玛=None, 二采引导器=None, 二采采样器=None, 二采VAE=None, segment_label="full", 返回一采结果=False):
