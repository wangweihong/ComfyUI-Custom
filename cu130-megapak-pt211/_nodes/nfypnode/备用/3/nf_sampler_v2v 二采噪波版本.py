...
class NanFengSamplerAdvancedV2V:
    ...
    def _execute_second_pass_from_input(self, second_input_latent, guider, sampler, 添加噪波, 噪波种子, 二采西格玛, segment_label="", guider_source="引导器", sampler_source="采样器", 二采噪波=None):
        ...
        second_noise, noise_source = self._resolve_second_pass_noise_obj(添加噪波, 噪波种子, 二采噪波=二采噪波)
        self._log(
            "SAMPLE",
            "开始执行二采。",
            level="INFO",
            ...
            noise_seed=getattr(second_noise, "seed", "unknown"),
        )
    ...
    def _run_single_pipeline(self, 引导器, 采样器, latent_input, 一采西格玛文本, 添加噪波, 噪波种子, 启动二采, 二采使用放大模型, 二采放大模型, 二采西格玛, 西格玛=None, 二采引导器=None, 二采采样器=None, 二采噪波=None, 二采VAE=None, segment_label="full", 返回一采结果=False, 是否图生视频=False, 二采latent输入图像=None, 二采图生视频VAE=None, 应用二采图生视频=False):
