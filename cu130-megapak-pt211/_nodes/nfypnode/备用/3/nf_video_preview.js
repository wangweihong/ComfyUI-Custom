...
function buildCrfApproxFilter(crf) {
    ...
    const blurPx = normalized * 1.15;
    const saturate = 1 - normalized * 0.16;
    ...
    async beforeRegisterNodeDef(nodeType, nodeData) {
        ...
        chainCallback(nodeType.prototype, "onNodeCreated", function () {
            ...
            this.applyPreviewStyle = () => {
                ...
                const crf = Number(crfWidget?.value ?? 19);
                ...
                previewWidget.videoEl.style.filter = finalFilter;
                previewWidget.imgEl.style.filter = finalFilter;
            };
